...
public class Viewdestination extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Viewdestination frame = new Viewdestination("");
    ...
    public Viewdestination(String username)  {
        setBounds(580, 220, 850, 600);
        contentPane = new JPanel();
        setContentPane(contentPane);
        contentPane.setLayout(null);

        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icon/20.jpg"));
        ...
        JLabel lblName = new JLabel("VIEW DESTINATION DETAILS");
        ...
        JLabel lb2 = new JLabel("Total Persons :");
        ...
        JLabel lblReserveRoomNumber = new JLabel("ID Type :");
