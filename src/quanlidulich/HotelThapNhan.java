...
public class  HotelThapNhan extends JFrame implements Runnable {
    ...
    public  HotelThapNhan() {
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel7.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel8.jpg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel9.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel10.jpg"));
    ...
    public static void main(String args[]){
        new HotelThapNhan().setVisible(true);
    }
