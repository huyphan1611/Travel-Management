...
public class DeleteDestination extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DeleteDestination frame = new DeleteDestination("");
    ...
    public DeleteDestination(String username) throws SQLException {
        ...
        JLabel lblName = new JLabel("DELETE DESTINATION");
        ...
        try{
            ...
            while(rs.next()){
                c1.add(rs.getString("destination"));
            }
        ...
        JLabel lblId = new JLabel("Destination :");
        ...
        JLabel lblName_1 = new JLabel("Days :");
        ...
        JLabel lblGender = new JLabel("ID Type :");
        ...
        JLabel lblCountry = new JLabel("ID Number :");
        ...
        JLabel lblCheckInStatus = new JLabel("Cost :");
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Conn c = new Conn();
                String destination= c1.getSelectedItem();

                try{
                    ResultSet rs = c.s.executeQuery("select * from bookplace where destination ='"+destination+"'");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    String q1 = "delete from bookplace where destination = '"+s1+"'";
