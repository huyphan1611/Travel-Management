...
public class DeleteHotel extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DeleteHotel frame = new DeleteHotel("");
    ...
    public DeleteHotel(String username) throws SQLException {
        ...
        JLabel lblName = new JLabel("DELETE HOTEL DETAILS");
        ...
        JLabel lblGender = new JLabel("Buffet :");
        ...
        JLabel lblCountry = new JLabel("ID Type :");
        ...
        JLabel lblReserveRoomNumber = new JLabel("ID Number :");
        ...
        JLabel lblDeposite = new JLabel("Cost :");
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ResultSet rs = c.s.executeQuery("select * from bookHotel where hotel ='"+hotel+"'");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    String q1 = "delete from bookHotel where hotel = '"+s1+"'";
