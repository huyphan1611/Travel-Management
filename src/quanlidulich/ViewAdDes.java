...
public class ViewAdDes extends JFrame {
    ...
    public ViewAdDes(String username) throws SQLException {
        //conn = Javaconnect.getDBConnection();
        //setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setBounds(550, 200, 800, 680);
        ...
        table = new JTable();
        table.setBounds(0, 40, 800, 350);
        contentPane.add(table);
        if(username.equals("admin")==true) {

            try {
                Conn c = new Conn();
                String displayCustomersql = "select * from bookplace";
            ...
            try {
                Conn c = new Conn();
                String displayCustomersql = "select * from bookplace where username = '"+username+"'";
                ResultSet rs = c.s.executeQuery(displayCustomersql);
                table.setModel(DbUtils.resultSetToTableModel(rs));
            } catch (Exception e1) {
                e1.printStackTrace();
        ...
        btnNewButton.setBounds(325, 600, 120, 30);
