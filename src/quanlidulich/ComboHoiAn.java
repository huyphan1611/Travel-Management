...
public class ComboHoiAn extends JFrame implements Runnable {
    ...
    public ComboHoiAn() {
        ...
        ImageIcon cb1 = new ImageIcon(ClassLoader.getSystemResource("combo/DN11.png"));
        ...
        ImageIcon cb4 = new ImageIcon(ClassLoader.getSystemResource("combo/DN12.png"));
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hoian/1.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("hoian/2.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("hoian/3.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("hoian/4.jpg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("hoian/5.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("hoian/6.jpg"));
        Image i17 = i16.getImage().getScaledInstance(900, 600, Image.SCALE_DEFAULT);
        ...
        /*ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("hoian/7.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("hoian/dest8.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("hoian/dest9.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("hoian/dest10.jpg"));
    ...
    public static void main(String args[]) {
        new ComboHoiAn().setVisible(true);
