        ...
        try{
            ...
            if(ae.getSource() == b1) {
                if (user.equals("") == true)
                    ...
                    JOptionPane.showMessageDialog(null, "Please enter anwser !");
                else {

                ResultSet rs = con.s.executeQuery("select * from account where username ='"+user+"'");
                while(rs.next()){
                    String check= rs.getString(1);
                   if(check.equals(user)==true)
                       JOptionPane.showMessageDialog(null, "Account has been used, please enter other username!");
                }
