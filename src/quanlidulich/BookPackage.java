...
public class BookPackage extends JFrame {
    ...
    public BookPackage(String username) {
        ...
        JLabel lblName = new JLabel("BOOK COMBO");
        ...
        JLabel lblId = new JLabel("Select Combo :");
        ...
        contentPane.add(l5);JLabel lblDayGo = new JLabel("Time:");
        lblDayGo.setBounds(35, 350, 200, 14);
        contentPane.add(lblDayGo);

        t2 = new JTextField();
        t2.setText("0");
        t2.setBounds(271, 350, 150, 20);
        contentPane.add(t2);
        t2.setColumns(10);
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(p.equals("Ha Long")) {
                    ...
                    cost += 2700;
                }else if(p.equals("Phu Quoc")){
                    cost += 2500;
                }else if(p.equals("Hoi An")){
                    cost += 2000;
                }
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    String q1 = "insert into bookcombo values('"+username+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+l5.getText()+"', '"+t2.getText()+"')";
        ...
        btnNewButton.setBounds(200, 420, 120, 30);
