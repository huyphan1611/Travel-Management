...
public class BookHotel extends JFrame {
    ...
    public BookHotel(String username) {
        ...
        JLabel laCb = new JLabel("Destination :");
        laCb.setBounds(35, 110, 200, 14);
        contentPane.add(laCb);

        JLabel lCb = new JLabel();
        lCb.setBounds(271, 110, 200, 14);
        contentPane.add(lCb);

        Conn c = new Conn();
        try{

            ResultSet rs = c.s.executeQuery("select * from bookplace where username = '"+username+"'");
            while(rs.next()){
                lCb.setText(rs.getString("destination"));
            }
        ...
        try{
            ...
            ResultSet rs = c.s.executeQuery("select * from destination where name = '"+lCb.getText()+"'");
            while(rs.next()){
...
*/
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        int cost = Integer.parseInt(rs.getString("costperday"));
                        int buffet = Integer.parseInt(rs.getString("costbuffet"));
                        ...
                        if(persons * days > 0) {
                            ...
                            total += foodprice.equals("Yes") ? buffet : 1;
                            total += cost;
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    String s1 = c1.getSelectedItem();
                    String q1 = "insert into bookHotel values('"+l1.getText()+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+t2.getText()+"', '"+c3.getSelectedItem()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+l5.getText()+"')";
